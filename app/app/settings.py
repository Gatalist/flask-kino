...
class Config(object):
    ...
    ROLE_SUPPER_ACCESSES_NAME = os.getenv('ROLE_SUPPER_ACCESSES_NAME')
    USER_SUPPER_ADMIN_NAME = os.getenv('USER_SUPPER_ADMIN_NAME')
    USER_SUPPER_ADMIN_PASSWORD = os.getenv('USER_SUPPER_ADMIN_PASSWORD')
    USER_SUPPER_ADMIN_EMAIL = os.getenv('USER_SUPPER_ADMIN_EMAIL')
    USER_SUPPER_ADMIN_DESCRIPTION = os.getenv('USER_SUPPER_ADMIN_DESCRIPTION')
