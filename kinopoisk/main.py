...
# start id -> 298 -> 4 647 040 +-     777
for movie_id in range(918, 3000):
    ...
    if movie and procese.get_movie(movie.get('kinopoiskId')):
        ...
        actor = procese.get_or_create_actor(elem_list=piople.get('actor'))
        ...
        similars = procese.get_or_create_similar(movie.get('kinopoiskId', None), similar)
